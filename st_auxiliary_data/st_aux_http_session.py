"""Provides simplified Http Session classes
"""
...
class SessionWithHeaderRedirection(requests.Session):
    ...
    def __init__(self, username, password, login_host,
                 max_retries=3, block_size=None, timeout=300.0):
        """Initialization of the class

        Args:
            username <str>: The username 
            password <str>: The password 
            login_host <str>: The name of the authorization host 
    ...
    def _stream_file(self, download_url, destination_file, headers=None):
        ...
        retrieved_bytes = 0
        with closing(self.get(url=download_url,
