...
;
;
; NAME:  lst_narr_step3_zeroDEM
;  
; PURPOSE:  IDL PROCEDURE
;   Generate transmission, upwelled radiance, and downwelled radiance at each pixel
;
; CALL SEQUENCE: lst_narr_step3_zeroDEM,     home, $            ;directory containing programs and supporting files
...
;                                    height             ;single height for entire scene (in km)
;
;  RESTRICTIONS:
...
PRO lst_narr_step3_zerodem,    home, $
                       directory, $
                       imageBase, $
                       numPoints, $
                       numHeights, $
...
;   demZone = demUTM
   ...
   ;offsetNorthing = ROUND((UL_demNorthing-UL_NORTH)/30D)
