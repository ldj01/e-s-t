...
# add current scene to scenelist
#scenelistname='scenelist'
#echo $imagebase >> $scenelistname.txt

# define single height for scene
height=0.0
...
idl -e "LST_MERRA_STEP3_ZERODEM, '$home/', '$directory/', '$imageBase', $numPoints, $numHeights,\
		           $landsatSamples, $landsatLines, $pixelSize, $zone,\
      		           $UL_EAST, $UL_NORTH, $UR_EAST, $UR_NORTH, $LL_EAST, $LL_NORTH, $LR_EAST, $LR_NORTH,\
            	 	   $UL_LAT, $UL_LON, $UR_LAT, $UR_LON, $LL_LAT, $LL_LON, $LR_LAT, $LR_LON,\
	                   $LMAX6, $LMIN6, $QCALMAX6, $QCALMIN6, $whichLandsat, '$height'"

echo "PIXEL PARAMETERS GENERATED"

echo "REMOVING INTERMEDIATE FILES"

# if [ -a ${home}/${directory}/results_float.tif ]
# then
rm -r $directory/HGT*
rm -r $directory/SHUM*
rm -r $directory/TMP*
rm -r $directory/GRIB
rm $directory/merra.hdf
rm -r $directory/[0-9]*
rm -r $directory/-[0-9]*
