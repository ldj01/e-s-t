...
;
; RESTRICTIONS:
;    1) when checking for clouds, more than 50 "cloud pixels" in the 10x10 surrounding the buoy means the scene should be skipped.
...
FUNCTION GET_ATM_PARAMS, folderpath, imagebase, buoylat, buoylon, whichLandsat, GETDIST2CLOUD=getdist2cloud
  ...
  IF KEYWORD_SET(getdist2cloud) THEN BEGIN
    ...
    minDistance= CALC_NEAREST_CLOUD_FROM_LOC(cloudmask, cmask_geotiff, buoyEast, buoyNorth)
