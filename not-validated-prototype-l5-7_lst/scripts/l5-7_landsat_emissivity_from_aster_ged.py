...
def process(args):
    ...
    landsat_emis_aux_filename = ''.join([landsat_emis_img_filename, '.aux',
                                         '.xml'])
    ...
    if os.path.exists(landsat_emis_aux_filename):
        os.unlink(landsat_emis_aux_filename)
    ...
    emis_band.set_long_name("Landsat emissivity estimated from ASTER GED data")
    emis_band.set_file_name(landsat_emis_img_filename)
