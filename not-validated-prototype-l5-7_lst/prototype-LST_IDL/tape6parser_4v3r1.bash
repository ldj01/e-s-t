...
linenum1=`grep -n "1 MULTIPLE" tape6_Mod4v3r1.txt |head -1| awk '{print $1}'| awk -F':' '{print $1}'`
sed "$linenum1,$ d" < tape6_Mod4v3r1.txt > tempfile
...
linenum2=`grep -n "0 FREQ" tempfile |head -1| awk '{print $1}' |awk -F':' '{print $1}'`
