...
;
; CALL SEQUENCE: lst_narr_step2, home, $            ;directory containing programs and supporting files
...
;
;  MODIFICATIONS
;    Feb 2012     Original code
;    Feb 2017     Changed hard-coded line numbers for RSRs to using FILE_LINES to get # of lines
;

PRO lst_narr_step2, home, $
                    directory, $
                    numPoints, $
                    numHeights, $
                    alb, $
   ...
   CASE whichLandsat OF
      ...
      END
      11: BEGIN
         nline = FILE_LINES(home+'L8_B11.rsp')
