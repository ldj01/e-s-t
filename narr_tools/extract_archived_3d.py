...
NARR_COORDINATES_PATH = ('../not-validated-prototype_lst'
...
def process_file(filename):
    ...
    output_path = '{0}.{1}.{2:0>4}.results'.format(parts[0], parts[2], hour)
...
def main():
    ...
    for archived_file in sorted(glob.glob('NARR_3D.*.grb')):
        process_file(archived_file)
