...
;
; CALL SEQUENCE: 
;    CALC_NEAREST_CLOUD_GLOBAL,   cloudmask, $               ; cloud mask to be altered
...
FUNCTION CALC_NEAREST_CLOUD_GLOBAL, cloudmask, cmask_geotiff, easting, northing
