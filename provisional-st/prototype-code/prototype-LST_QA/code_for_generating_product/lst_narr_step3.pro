...
;
; CALL SEQUENCE: lst_narr_step3,     home, $            ;directory containing programs and supporting files
...
;   demZone = demUTM
   ...
   WRITE_TIFF, home+directory+imagebase+'_LSTparams_NARR.tif', $ 
